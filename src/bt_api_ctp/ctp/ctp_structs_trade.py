...
class CThostFtdcTradeField:
    ...
    InvestorID = property(
        _ctp.CThostFtdcTradeField_InvestorID_get,
        _ctp.CThostFtdcTradeField_InvestorID_set,
    )
    reserve1 = property(
    ...
    OrderSysID = property(
        _ctp.CThostFtdcTradeField_OrderSysID_get,
        _ctp.CThostFtdcTradeField_OrderSysID_set,
    )
    ParticipantID = property(
        _ctp.CThostFtdcTradeField_ParticipantID_get,
        _ctp.CThostFtdcTradeField_ParticipantID_set,
    )
    ClientID = property(
        _ctp.CThostFtdcTradeField_ClientID_get, _ctp.CThostFtdcTradeField_ClientID_set
    )
    TradingRole = property(
        _ctp.CThostFtdcTradeField_TradingRole_get,
        _ctp.CThostFtdcTradeField_TradingRole_set,
    )
    reserve2 = property(
        _ctp.CThostFtdcTradeField_reserve2_get, _ctp.CThostFtdcTradeField_reserve2_set
    )
    OffsetFlag = property(
        _ctp.CThostFtdcTradeField_OffsetFlag_get,
        _ctp.CThostFtdcTradeField_OffsetFlag_set,
    )
    HedgeFlag = property(
    ...
    PriceSource = property(
        _ctp.CThostFtdcTradeField_PriceSource_get,
        _ctp.CThostFtdcTradeField_PriceSource_set,
    )
    TraderID = property(
        _ctp.CThostFtdcTradeField_TraderID_get, _ctp.CThostFtdcTradeField_TraderID_set
    )
    OrderLocalID = property(
        _ctp.CThostFtdcTradeField_OrderLocalID_get,
        _ctp.CThostFtdcTradeField_OrderLocalID_set,
    )
    ClearingPartID = property(
        _ctp.CThostFtdcTradeField_ClearingPartID_get,
        _ctp.CThostFtdcTradeField_ClearingPartID_set,
    )
    BusinessUnit = property(
        _ctp.CThostFtdcTradeField_BusinessUnit_get,
        _ctp.CThostFtdcTradeField_BusinessUnit_set,
    )
    SequenceNo = property(
        _ctp.CThostFtdcTradeField_SequenceNo_get,
        _ctp.CThostFtdcTradeField_SequenceNo_set,
    )
    TradingDay = property(
        _ctp.CThostFtdcTradeField_TradingDay_get,
        _ctp.CThostFtdcTradeField_TradingDay_set,
    )
    SettlementID = property(
        _ctp.CThostFtdcTradeField_SettlementID_get,
        _ctp.CThostFtdcTradeField_SettlementID_set,
    )
    BrokerOrderSeq = property(
        _ctp.CThostFtdcTradeField_BrokerOrderSeq_get,
        _ctp.CThostFtdcTradeField_BrokerOrderSeq_set,
    )
    TradeSource = property(
        _ctp.CThostFtdcTradeField_TradeSource_get,
        _ctp.CThostFtdcTradeField_TradeSource_set,
    )
    InvestUnitID = property(
        _ctp.CThostFtdcTradeField_InvestUnitID_get,
        _ctp.CThostFtdcTradeField_InvestUnitID_set,
    )
    InstrumentID = property(
        _ctp.CThostFtdcTradeField_InstrumentID_get,
        _ctp.CThostFtdcTradeField_InstrumentID_set,
    )
    ExchangeInstID = property(
        _ctp.CThostFtdcTradeField_ExchangeInstID_get,
        _ctp.CThostFtdcTradeField_ExchangeInstID_set,
    )
...
class CThostFtdcTradeParamField:
    ...
    __repr__ = _swig_repr
    BrokerID = property(
        _ctp.CThostFtdcTradeParamField_BrokerID_get,
        _ctp.CThostFtdcTradeParamField_BrokerID_set,
    )
