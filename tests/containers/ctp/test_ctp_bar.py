...
class TestCtpBarData:
    ...
    def test_get_server_time_initializes_before_access(self):
        """Test server time is available without an explicit initialization call."""
        bar = CtpBarData({'close_time': '20250404 10:15:00'})
    ...
    def test_get_open_time_initializes_before_access(self):
        """Test open time is available without an explicit initialization call."""
        bar = CtpBarData({'open_time': '20250404 09:00:00'})
    ...
    def test_get_close_time_initializes_before_access(self):
        """Test close time is available without an explicit initialization call."""
        bar = CtpBarData({'close_time': '20250404 10:15:00'})
